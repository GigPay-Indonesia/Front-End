...
## 1. Purpose
Testnet ERC20 token used for local/testing flows (USDT-like). Supports minting for operators and standard ERC20 transfers.

---

## 2. Deployment (Base Sepolia)
- Address: `0xDbb4DEfa899F25Fd1727D55cfb66F6EB0C378893`
- Explorer: https://base-sepolia.blockscout.com/address/0xDbb4DEfa899F25Fd1727D55cfb66F6EB0C378893
- ABI: `abis/MockUSDT.abi.json`
...
## 8. Example Call Flow
```
await mockUsdt.approve(escrowCore, amount);
```
