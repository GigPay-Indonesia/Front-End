...
## 1. Purpose
Testnet ERC20 token used for local/testing flows (USDC-like). Supports minting for operators and standard ERC20 transfers.

---

## 2. Deployment (Base Sepolia)
- Address: `0x44E7c97Ee6EC2B25145Acf350DBBf636615e198d`
- Explorer: https://base-sepolia.blockscout.com/address/0x44E7c97Ee6EC2B25145Acf350DBBf636615e198d
- ABI: `abis/MockUSDC.abi.json`
...
## 8. Example Call Flow
```
await mockUsdc.approve(escrowCore, amount);
```
