...
## 1. Purpose
Testnet ERC20 token used for local/testing flows (IDRX-like). Supports minting for operators and standard ERC20 transfers.

---

## 2. Deployment (Base Sepolia)
- Address: `0x20Abd5644f1f77155c63A8818C75540F770ae223`
- Explorer: https://base-sepolia.blockscout.com/address/0x20Abd5644f1f77155c63A8818C75540F770ae223
- ABI: `abis/MockIDRX.abi.json`
...
## 8. Example Call Flow
```
await mockIdrx.approve(escrowCore, amount);
```
